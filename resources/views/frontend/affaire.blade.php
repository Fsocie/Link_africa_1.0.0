                        ...
                        <div class="row">
                            <div class="col-lg-10 mx-auto mb-4">
                                <div class="section-title text-center ">
                                    <h6> 
                                        Publiez et consultez les annonces couvrant les 17 pays de l'OHADA. 
                                        Vous êtes à la recherche d'un emploi ? Trouvez les meilleures opportunités du monde du travail sur Link_afrique.
                                    </h6>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                                                <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                                                    <div class="img-holder mr-md-4 mb-md-0 mb-4 mx-auto mx-md-0 d-md-none d-lg-flex">
                                                        <p>{{ Str::limit($affaire->nom, 2) }}</p> 
                                                    </div>
                                                    <div class="job-content">
                                                        <h5 class="text-center text-md-left">{{ $affaire->nom }}</h5>
                                                        <ul class="d-md-flex flex-wrap text-capitalize ff-open-sans">
                                                            <li class="mr-md-4">
                                                                <p><b>Titre</b> : {{ $affaire->titre }}</p>
                                                            </li>
